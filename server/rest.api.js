    ...
    },
    {
        ...
        children: [
            {name:'list',path: '/paper/list',api:[
                    ...
                    {url:'setPaperStatus',type:'post',_params:{paperId:'p111',status:'ON'},description:'切换一项问卷状态',response1:{code:200,msg:'success'},response2:{code:400,msg:'failed'}},
            ...
            {name:'analysis',path: '/paper/analysis/:paperId',api:[
                    ...
                    {url:'deleteAnswer',type:'get',_params:{answerId:'a111'},description:'删除答案',response1:{},response2:{code:400,msg:'failed'}},
                ],},
        ]
    },
     {
